    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/users/**").hasAnyRole("USER", "PROF", "ADMIN")
                        .requestMatchers(org.springframework.http.HttpMethod.GET, "/api/lessons/my").hasRole("USER")
                        .requestMatchers(org.springframework.http.HttpMethod.POST, "/api/lessons/*/enrollments").hasRole("USER")
                        .requestMatchers(org.springframework.http.HttpMethod.DELETE, "/api/lessons/*/enrollments").hasRole("USER")
                        ...
                        .requestMatchers(org.springframework.http.HttpMethod.GET, "/api/lectures/**")
                                .hasAnyRole("USER", "PROF", "ADMIN")
                        .requestMatchers("/api/materials/**").hasAnyRole("USER", "PROF", "ADMIN")
